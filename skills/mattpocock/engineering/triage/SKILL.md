...
These are canonical role names. The actual label strings used in the issue tracker may differ. The mapping should have been provided to you. If not, look for `docs/agents/issue-tracker.md` in the target repo; when there is none, ask the user which tracker to use.
