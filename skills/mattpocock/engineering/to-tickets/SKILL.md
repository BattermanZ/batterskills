...
Publish the approved tickets. **How** depends on the tracker the repo is configured for (`docs/agents/issue-tracker.md`); the tickets are the same either way, only the shape of the blocking edges changes:
